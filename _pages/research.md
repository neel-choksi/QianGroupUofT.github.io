...
![]({{ site.url }}{{ site.baseurl }}/images/respic/img1.png){: style="width: 300px; float: left; margin: 100px  100px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/respic/img2.png){: style="width: 500px; float: left; margin: 100px  100px"}
