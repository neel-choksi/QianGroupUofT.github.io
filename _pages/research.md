...
![]({{ site.url }}{{ site.baseurl }}/images/respic/img1.png){: style="width: 500px; float: left; margin: 150px  150px"}
...
![]({{ site.url }}{{ site.baseurl }}/images/respic/img2.png){: style="width: 500px; float: left; margin: 150px  150px"}
